...
public class AddremoveCombo extends MyCombo implements ItemListener, ActionListener
{
    private OrderableList list=null;
    private Hashtable checkelems=null;
    ...
    void setCheckElems (Hashtable hashelems)
    {
