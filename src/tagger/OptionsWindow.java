...
public class OptionsWindow extends JFrame {
	...
	public class dbOptions extends JPanel implements ActionListener {
		...
		dbOptions() {
			...
			button = new MyButton(MyButton.NORMAL_BUTTON, null, "browsestart", Utils.getImage("main", "browsedir"),
					this);
			...
			pan2.setAlignmentX(JComponent.LEFT_ALIGNMENT);
			pan2.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 10));
			button = new MyButton(MyButton.NORMAL_BUTTON, null, "browsestop", Utils.getImage("main", "browsedir"),
					this);
			button.setToolTipText("Browse directories");
			pan2.add(button);
			pan3.add(pan2);
