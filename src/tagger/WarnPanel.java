...
public class WarnPanel extends JPanel
{
    ...
    private ImageIcon img[]=new ImageIcon[]
          {Utils.getImage("warnpanel","ok"),Utils.getImage("warnpanel","warning"),Utils.getImage("warnpanel","error")};
	...
	return ("<html><B><font size=-1 color=#"+color.substring(2,8)+">"+linetext.substring(0,linetext.length())+"");
    }
