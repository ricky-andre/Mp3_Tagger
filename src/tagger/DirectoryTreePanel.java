...
public class DirectoryTreePanel extends JPanel implements ActionListener, ItemListener
{
    ...
    private JComboBox dirselect=new JComboBox(); 

    
    // private String[] selchoices=new String[] {" "," "," "," "," "," "," "," "," "," "," ",""};
    // private Hashtable inserted=new Hashtable ();
	...
	if (!elem.equals("") && ie.getStateChange()==ItemEvent.SELECTED)
		...
		if (file.exists())
		    ...
		    JOptionPane.showMessageDialog(null,"Directory \""+elem+"\" does not exist!","Directory \""+elem+"\" does not exist!",JOptionPane.INFORMATION_MESSAGE);
	...
	treescrollpane=new JScrollPane (tree,ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
